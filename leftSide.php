<div class="column1" style="background-color:#78C0E0;border-radius: 12px;box-shadow: 2px 2px 12px #78C0E0">
    ...
    <br>
    <input type="submit" name="codeForcesVar" value="Codeforces" class="ContestBtn" style="background-color: #fff;color: #185BB8;">
    <br>
    <input type="submit" name="hackerEarthVar" value="HackerEarth"  class="ContestBtn" style="background-color:#2B3455">
    <br>
    <input type="submit" name="leetCodeVar" value="LeetCode" class="ContestBtn" style="background-color:#FDA115">
    <br>
    <input type="submit" name="spojVar" value="spoj" class="ContestBtn" style="background-color:#2B5B96;color:#fff;">
    </form><br>
